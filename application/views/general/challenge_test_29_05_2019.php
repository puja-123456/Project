        ...
        <div class="modal-body">
          ...
          <!--   <div class="content"> -->
            ...
            <ul class="cases">
                ...
                <li><p> When the question is found to be incorrect or incomplete or none of the answers are correct
The question will be dropped and the marks allocated to that question will be awarded to all the students.</p></li>
                 <li><p> When the question is correct but the official answer key provided by <b>CREST</b> Olympiads is incorrect and the other option is correct
The correct answer will be changed and the score of all the students will be recalculated.</p> </li>
                  <li><p> When the question is correct and the official answer provided by <b>CREST</b> Olympiads is correct. However, there is another option which is correct too
The students' score, who marked the option correctly (which was initially marked as incorrect) will be updated.</p></li>
...
if( substr($user_subjects[$j]->worksheet_id, 0, 1)=="R")
{
...
//if($user_subjects[$j]->short_subject_name==strtolower($value))
         if (in_array($short_subject_name, $subjects))
{
	echo $i." : "."<a href='".base_url()."crest/challenge_test/".strtolower($value)."'>$value</a>( Challenge Window: ".$quiz_subscription_info['from_challenge_date']." to ".$quiz_subscription_info['to_challenge_date'].")";
	echo "<br/>";
	$i++;
	$j++;
}
...
?>
	<p>
					* Please note that Rs. 100 will be charged for every question which you challenge. If your challenge is accepted by our review team, the amount will be reimbursed to you. For any queries, write to us at <a href="mailto:info@crestolympiads.com">info@crestolympiads.com</a>.
                                	 ...
                                	 <?php  if (isset($q->answer1)) { 
                                            ...
                                            if(isset($q->y_ans) && $q->y_ans==='a') { echo 'checked'; } ?>></td> -->
                                                  <td style="padding-bottom: 5px;" valign="top" align="left">
                                                    <?php if(isset($q->answer1Image) && $q->answer1Image != ''){ echo "a : " ?><img src="<?php echo $img_url.'uploads/'.$q->answer1Image ?>" ><br><?php } else {  echo "a : ".htmlText($q->answer1); } ?>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                            <?php
                                                ...
                                                <tr>
                                                  ...
                                                  if(isset($q->y_ans) && $q->y_ans==='b') { echo 'checked';} ?>></td> -->
                                                       <td style="padding-bottom: 5px;" valign="top" align="left">
                                                        ...
                                                        <?php if(isset($q->answer2Image) && $q->answer2Image != ''){ echo "b : "  ?><img src="<?php echo $img_url.'uploads/'.$q->answer2Image ?>" ><br><?php } else {  echo "b : ".htmlText($q->answer2); } ?>
                                                    </td>
                                                </tr>
                                                <?php } ?>
                                                <?php
                                                if (isset($q->answer3)) {
                                                  ...
                                                  if(isset($q->y_ans) && $q->y_ans==='c') { echo 'checked';} ?>></td> -->
                                                           <td style="padding-bottom: 5px;" valign="top" align="left">
                                                            ...
                                                            <?php if(isset($q->answer3Image) && $q->answer3Image != ''){ echo "c : "  ?><img src="<?php echo $img_url.'uploads/'.$q->answer3Image ?>" ><br><?php } else {  echo "c : ". htmlText($q->answer3); } ?>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                                                    <?php
                                                  ...
                                                  if(isset($q->y_ans) && $q->y_ans==='d') { echo 'checked';} ?>></td> -->
                                                               <td style="padding-bottom: 5px;" valign="top" align="left">
                                                                ...
                                                                <?php if(isset($q->answer4Image) && $q->answer4Image != ''){ echo "d : "  ?><img src="<?php echo $img_url.'uploads/'.$q->answer4Image ?>" ><br><?php } else {  echo "d : ". htmlText($q->answer4); } ?>
                                                            </td>
                                                        </tr>
                                                        <?php } ?>
...
<!-- 
                                           ...
                                           <span>Would you like to challenge ?</span>

                                           <select name="<?php echo $q->questionid; ?>_option" id="<?php echo $q->questionid; ?>_option" class="option" style="height:auto;" >
                                           	<option value="">Select Option</option>

                                           	 <?php if($q->correctAnswer !="a"){ echo "<option value='a'>a</option>";} ?>
                                           	 <?php if($q->correctAnswer !="b"){ echo "<option value='b'>b</option>";} ?>
                                          	 <?php if($q->correctAnswer !="c"){ echo "<option value='c'>c</option>";} ?>
                                           	 <?php if($q->correctAnswer !="d"){ echo "<option value='d'>d</option>";} ?>
                                     ...
                                     <!--   </tr>
                                           <tr> -->
                                           	<td>                                         	
                                                ...
                                                <textarea id="<?php echo $q->questionid; ?>_comment" name="<?php echo $q->questionid; ?>_comment" class="comment" style="height:auto; padding-top: 100px" rows="10" cols="40" placeholder="Justification for Your Answer."></textarea>
    ...
    // $('.whatsapp').click(function() {
        ...
        if( isMobile.any() ) {
            ...
            // window.location.href = whatsapp_url;
             ...
             var base_url= "http://www.talentolympiad.com/";
             alert("You may view this link only through a desktop only.");
